...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xmsg_5fhead_2eproto = {
  false, false, descriptor_table_protodef_xmsg_5fhead_2eproto, "xmsg_head.proto", 96,
...
static bool dynamic_init_dummy_xmsg_5fhead_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_xmsg_5fhead_2eproto)), true);
namespace xmsg {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "xmsg.XMsgHead.msg_str"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 msg_type = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* XMsgHead::_InternalSerialize(
