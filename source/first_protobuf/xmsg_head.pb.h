...
inline ::PROTOBUF_NAMESPACE_ID::int32 XMsgHead::_internal_msg_size() const {
  return msg_size_;
}
...
inline void XMsgHead::_internal_set_msg_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline std::string* XMsgHead::unsafe_arena_release_msg_str() {
  // @@protoc_insertion_point(field_unsafe_arena_release:xmsg.XMsgHead.msg_str)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return msg_str_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void XMsgHead::unsafe_arena_set_allocated_msg_str(
    std::string* msg_str) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (msg_str != nullptr) {
  ...
  msg_str_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      msg_str, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:xmsg.XMsgHead.msg_str)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 XMsgHead::_internal_msg_type() const {
  return msg_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 XMsgHead::msg_type() const {
  // @@protoc_insertion_point(field_get:xmsg.XMsgHead.msg_type)
  return _internal_msg_type();
}
inline void XMsgHead::_internal_set_msg_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  msg_type_ = value;
}
inline void XMsgHead::set_msg_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
